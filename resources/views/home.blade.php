                ...
                <div class=" trans" style="margin: 100px 0 100px 0; background-color: rgba(0, 0, 0, 0.5);">
                    <div class="row">
                        <div class="col-sm center-dist" align="center">
                            ...
                            <a style="margin-bottom: 50px;" href="{{url('/produk')}}" class="btn btn-danger">Belanja
                                Sekarang</a>
                        </div>
                    </div>
                </div>
...
<div class="row justify-content-center">
    ...
    <div class="col-md-2">
        <div class="card" style="margin:20px;">
            <img class="card-img-top" src="storage/img/produk/{{$value->foto}}" alt="Card image cap" width="100%;">
        </div>
    </div>
    @endforeach
</div>
